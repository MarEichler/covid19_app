...
VAROPTS <- tibble::tribble(
  ...
  ,  "C", "C_CUM_PC"   , "pc"   , 0.01      , 0.1    , "Total Cases Per Capita"
...
# ,  "C", "C_MA7_PC"   , "pc"   , 0.0000001 , 0.00001, "Daily Cases 7-Day Moving Average Per Capita"
  ...
  ,  "D", "D_CUM_PC"   , "pc"   , 0.0001    , 0.01   , "Total Deaths Per Capita"
...
# ,  "D", "D_MA7_PC"   , "pc"   , 0.00000001, 0.00001, "Daily Deaths 7-Day Moving Average Per Capita"
  ...
  ,  "D", "D_NEW_P100K", "p100k", 0.1       , 0.1    , "Daily Deaths per 100,000"
  ,  "D", "D_MA7_P100K", "p100k", 0.1       , 0.1    , "Daily Deaths 7-Day Moving Average per 100,000"
)
